                    ...
                    <div className="mt-12 mb-8 flex flex-col gap-12">
                        <div className="section cards mx-auto border grid md:grid-cols-3 md:px-12 bg-gray-200 text-gray-800">
                            {currentCourses.map((course) => (
                                ...
                                >
                                    <Link to={`/StuPg/DescriptionCourse/courses/${course._id}`}>
                                    ...
                                    <button onClick={() => {console.log("aaa"); handleAddToCart(course._id)}} 
                                    className="bg-black text-white font-bold py-2 px-4 rounded-full mt-4">
                                        Add To Cart
                                    </button>
                                </div>
                            ))}
