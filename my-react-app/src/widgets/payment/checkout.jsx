          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                id="email"
                name="email"
                className="w-full rounded-md border border-gray-200 bg-white py-3 px-4 text-sm text-gray-500 shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
              ...
              <div className="pointer-events-none absolute inset-y-0 right-0 hidden items-center pr-3 sm:flex">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1.707-4.707a1 1 0 011.414 0L10 12.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-1-1z"
                    clipRule="evenodd"
                  />
                </svg>
              </div>
