...
export const addAdmin = createAsyncThunk('admin/addAdmin', async({Name, Email, Password, Image,Role})=>{
    try { 
        const res = await axios.post('http://localhost:3000/admin/addAdmin', {Name ,Email , Password, Image,Role})
        return res.data;
    } catch (error) {
        console.log(error);
    }
