import {
  ...
  import {addStudent} from '@/redux/student/slice'


function AddStudent({show}){
   ...
   async function addButton() {
      ...
      if (secureUrl) {
          dispatch(addStudent({firstname, lastname, email,username,password,phoneNumber, Image : secureUrl}))
       }
       }
