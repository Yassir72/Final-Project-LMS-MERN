...
<section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 "> 
    ...
    <section className="w-full py-12 md:py-16 lg:py-20">
      <div className="container grid gap-6 px-4 md:px-6">
        ...
        <div className="overflow-x-auto -mx-4 md:-mx-6 pb-4">
          <div className="inline-grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6 w-max min-w-full">
            <div className="relative group overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out">
